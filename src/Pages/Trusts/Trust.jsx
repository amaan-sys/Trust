...
import TrustAdmin from "../../Components/Trust/TrustAdmin";
...
export default function TrustAdministration_OLD() {
  return (
    <div className="font-sans text-gray-900 leading-relaxed">
      {/* Hero / Header */
    //   <div className="w-full h-[500px] md:h-[450px] bg-cover bg-center" style={{ backgroundImage: `url(${trustHeaderImage})` }}>
    ...
    //       trust for the best interest of the beneficiaries.
    //     </p>
    ...
    //         the trust terms, including the trustees and beneficiaries.
    //       </li>
    //       <li>
    ...
    //         to limit estate taxes or to shield assets from creditors.
    //       </li>
    //       <li>
    ...
    //         that is funded and effective after the grantor has died.
    //       </li>
    //       <li>
    ...
    //         grow assets and act as a spendthrift tool.
    //       </li>
    //     </ul>
    ...
    //           in trust for the benefit of the ultimate recipient.
    //         </p>
    //       </div>
    ...
    //           benefits are used, and the duration of the trust.
    //         </p>
    //       </div>
    ...
    //           and has a duty of loyalty solely to trust beneficiaries.
    //         </p>
    //       </div>
