...
export default function EstateAdministration() {
  return (
    <div className="font-sans text-gray-900 leading-relaxed">
      {/* Hero / Header */}
      <div className="w-full h-[500px] md:h-[450px] bg-cover bg-center" style={{ backgroundImage: `url(${estateHeaderImage})` }}>
      ...
      <div className="max-w-3xl mx-auto mt-12 px-4 space-y-6">
        ...
        <ul className="list-disc list-inside space-y-3 text-lg pl-4">
          <li>
            <strong>Objectivity:</strong> Choosing a professional fiduciary eliminates potential conflicts of interest among family members. Entrusting these responsibilities to a professional ensures that estate assets are managed and distributed according to your plan.
          </li>
          <li>
            <strong>Expertise:</strong> The role of a Personal Representative requires knowledge of estate and tax law. Our team of seasoned professionals has years of experience in estate administration, ensuring a thorough understanding of the complexities involved in carrying out your final wishes.
          </li>
          <li>
            <strong>Oversight:</strong> As a Washington chartered trust company, our business activities are periodically reviewed and examined by the Washington State Department of Financial Institutions, providing an additional layer of oversight and accountability.
          </li>
        </ul>
        ...
        <div className="space-y-8 mt-6 text-lg">
          <div>
            ...
            <p>
              Sometimes called an Executor, a Personal Representative is the individual or company appointed by a Will to administer an estate for someone who has died. Responsibilities include marshaling all assets, paying outstanding debts, filing final tax returns, and distributing remaining estate assets to the named beneficiaries.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              We do this work every day and have expertise with probate law, required tax filings, beneficiary communication, and we have a wealth of resources to assist with estate settlement. We are neutral, impartial, and objective. Our sole duty is to carry out the wishes of the decedent.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Our policy is to serve as the sole Personal Representative in estate planning documents prepared by a licensed attorney only. We do not serve as co-Personal Representative, and we reserve the right to decline appointments at any time.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Please have the drafting attorney use the following language: "WE Trust Company, a Washington chartered trust company, and its successor and assigns."
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              WE Trust Company charges by the hour for estate administration only when called to serve. There is no fee to name us in documents. A fee schedule is available upon request.
            </p>
          </div>
        </div>
      </div>
