...
import attorneyHeaderImage from "../../assets/Familyoff.jpg";

export default function FinancialPOA() {
  return (
    <div className="text-gray-900 leading-relaxed">
      {/* Hero */}
      <div className="w-full h-[500px] md:h-[450px] bg-cover bg-center" style={{ backgroundImage: `url(${attorneyHeaderImage})` }}>
